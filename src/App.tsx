...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from './components/ui/select';  // Assume shadcn/ui or similar; adapt if not present
import { Card, CardContent, CardHeader, CardTitle } from './components/ui/card';  // Adapt to existing UI
...
const REPO_BASE = 'https://raw.githubusercontent.com/bryceSA/world-temp-explorer/main';  // Your repo URL
...
const App: React.FC = () => {
  ...
  // Fetch historical and forecast data from JSON
  useEffect(() => {
